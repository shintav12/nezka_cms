    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var dataTable = $('#user').DataTable({
                "processing": true,
                "serverSide": true,
                "ajax": "{{ route('get_services_customer')}}",
                order: [[0, "asc"]],
                "language": {
                ...
                "aoColumnDefs": [
                    ...
                    },
                    {
                        ...
                        "mData": null,
                        "mRender": function (data, type, full) {
                            return '<a href="{{url("services_customer/detail")}}/' + full.id + '" class="btn btn-primary"><i class="fa fa-edit"></i>&nbsp;Editar</a>';
                        }
                    ...
                    $('.switch').bootstrapSwitch(
                        {
                            ...
                            'onSwitchChange': function(event, state){
                                ...
                                $.ajax({
                                    type: "POST",
                                    dataType: "JSON",
                                    url: "{{route('change_status_services_customer')}}",
        ...
        <div class="col-xs-12">
            <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    <a href="{{route('services_customer_detail')}}" class="btn btn-primary"><i class="fa fa-plus-circle"></i>&nbsp;Nuevo</a>
                    <div class="tools"> </div>
                </div>
