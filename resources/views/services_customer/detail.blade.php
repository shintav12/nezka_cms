            ...
            $("#form-user").validate({
                ...
                submitHandler: function (form) {
                        ...
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "{{ route('services_customer_save') }}",
                            ...
                            success: function (data) {
                                ...
                                if (error == 0) {
                                    window.location = "{{ url(route('services_customer'))}}";
                                } else {
                                    swal.close();
                                    swal(
                                        'Oops...',
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="col-xs-12">
                                                    ...
                                                    <input type="text" class="form-control" name="description" value="<?php if( isset($item) )  echo $item->description;?>" placeholder="Ingrese el nombre del blog">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="col-md-3 col-md-9">
                                        ...
                                        <a type="button" href="{{route('services_customer')}}" class="btn default">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </div>
