                ...
                submitHandler: function (form) {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                if (error == 0) {
                                    window.location = "{{ url(route('news'))}}";
                                } else {
                                    swal.close();
                                    swal(
                                        'Oops...',
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="col-xs-12">
                                                    <label>Link</label>
                                                    <input type="text" class="form-control" name="link" value="<?php if( isset($item) )  echo $item->url;?>" placeholder="Ingrese el nombre del blog">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="col-md-3 col-md-9">
                                        ...
                                        <a type="button" href="{{route('news')}}" class="btn default">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </div>
